...
function M.get(opts)
  ...
  local groups = {
    ...
    TelescopeResultsTitle = { fg = c.bg, bg = c.lilac, bold = true },
    ...
    TelescopeSelection = { fg = c.bg, bg = c.pink, bold = true },
    TelescopeSelectionCaret = { fg = c.orange, bg = c.pink },
    TelescopeMultiSelection = { fg = c.bg, bg = c.purple },
